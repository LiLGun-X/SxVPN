...
wget https://raw.githubusercontent.com/LiLGun-X/SxVPN/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
...
echo "   - เจ้าของ                   : lil gun-x" | tee -a log-install.txt
